...
class Settings:
    ...
    RABBITMQ_EXCHANGE_NAME: str | None = os.getenv("RABBITMQ_EXCHANGE_NAME")
    RABBITMQ_ROUTING_KEY: str | None = os.getenv("RABBITMQ_ROUTING_KEY")
    ...
    RABBITMQ_MAX_PRIORITY: int = int(os.getenv("RABBITMQ_MAX_PRIORITY", "2050"))
    RABBITMQ_MAX_RETRIES: int = int(os.getenv("RABBITMQ_MAX_RETRIES", "5"))
    RABBITMQ_RETRY_DELAY_MS: int = int(os.getenv("RABBITMQ_RETRY_DELAY_MS", "10000"))
