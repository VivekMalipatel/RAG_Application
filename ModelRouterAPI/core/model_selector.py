...
class ModelSelector:
    def __init__(self):
        ...
        self.static_provider_mappings = {
            Provider.HUGGINGFACE: settings.HUGGINGFACE_MODELS,
            Provider.OLLAMA: settings.OLLAMA_MODELS
        }
    ...
    def _find_provider_for_model(self, model_name: str) -> Provider:
        ...
        for provider, models in self.static_provider_mappings.items():
